...
export default function HomePage() {
  ...
  return (
    <main className="container mx-auto px-4 py-8 max-w-7xl min-h-screen bg-gray-50">
        ...
        <form onSubmit={(e) => { e.preventDefault(); loadProducts(true); }} className="space-y-6">
          <div className="relative">
            <input
              ...
              className="w-full p-4 bg-white border-2 border-slate-900 rounded-xl outline-none text-slate-900 placeholder:text-slate-500 font-bold"
              value={query}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <select 
                className="w-full p-3 bg-white border-2 border-slate-900 rounded-xl font-bold text-slate-900"
            ...
            <div className="space-y-2">
              <label className="text-sm font-black text-slate-900 uppercase">Sort By</label>
              <select 
                className="w-full p-3 bg-white border-2 border-slate-900 rounded-xl font-bold text-slate-900"
                value={sortBy}
              ...
              >
                ...
                <option value="nutrition_grades">Nutrition Grade (Healthy First)</option>
              </select>
            </div>
          </div>
        </form>
